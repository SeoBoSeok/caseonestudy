        ...
        promises.push(
          browser.newPage().then(async page => {
            ...
            try {
              ...
              await page.click(
                "section.sp_ntotal .api_subject_bx ul #web_1 .title_area a.api_txt_lines"
              );
              ...
              await page.goto(blogUrl2[0], {
                waitUntil: "networkidle2"
              });
              await page.waitFor(50000);
              await page.goto(blogUrl2[1], {
                waitUntil: "networkidle2"
              });
              await page.waitFor(50000);
              await page.goto(blogUrl2[2], {
                waitUntil: "networkidle2"
              });
              await page.waitFor(50000);
              await page.goto(blogUrl2[3], {
                waitUntil: "networkidle2"
              });
              await page.waitFor(50000);
              await page
